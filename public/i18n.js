...
const I18N = {
  vi: {
    ...
    biliDownloadEngineLabel: "Downloader Bilibili:",
    biliDownloadEngineTip: "aria2 tạo nhiều HTTP Range connection cho file .m4s; manifest vẫn dùng native.",
    biliDownloadEngineAuto: "⚡ Auto (aria2 nếu có, fallback native)",
    biliDownloadEngineNative: "🧩 Native yt-dlp",
    biliDownloadEngineAria2: "🚀 aria2 multi-range",
    biliAria2ConnectionsLabel: "Connections mỗi file:",
    biliAria2ConnectionsTip: "Số Range connection cho một file. Bắt đầu với 8; quá nhiều có thể gây 403/429.",
    biliAria2Checking: "Đang kiểm tra aria2...",
    biliAria2Ready: "✅ aria2 sẵn sàng",
    biliAria2Unavailable: "ℹ️ Chưa có aria2 — Auto dùng native",
    biliAria2ChunkIgnored: "aria2 đang tự chia Range; chunk native được bỏ qua",
    ...
    biliUposHostTip: "Chọn candidate CDN UPOS để tải video Bilibili. Tốc độ thực tế phụ thuộc mạng và thời điểm; dùng Fastest để probe các URL được trả về.",
    biliUposAuto: "⚡ Tự động (Ưu tiên CDN Quốc tế Alibaba / Tencent)",
    biliUposFastest: "🧪 Fastest (Đo các backup URL thật trước khi tải)",
    biliUposAliOv: "🌏 Alibaba Overseas CDN (upos-sz-mirroraliov) — Candidate thủ công",
  ...
  en: {
    ...
    biliDownloadEngineLabel: "Bilibili downloader:",
    biliDownloadEngineTip: "aria2 opens multiple HTTP Range connections for .m4s files; manifests stay native.",
    biliDownloadEngineAuto: "⚡ Auto (aria2 when available, native fallback)",
    biliDownloadEngineNative: "🧩 Native yt-dlp",
    biliDownloadEngineAria2: "🚀 aria2 multi-range",
    biliAria2ConnectionsLabel: "Connections per file:",
    biliAria2ConnectionsTip: "Range connections for one file. Start at 8; too many may cause 403/429.",
    biliAria2Checking: "Checking aria2...",
    biliAria2Ready: "✅ aria2 ready",
    biliAria2Unavailable: "ℹ️ aria2 unavailable — Auto uses native",
    biliAria2ChunkIgnored: "aria2 splits ranges; native chunk is ignored",
    ...
    biliUposHostTip: "Choose a UPOS CDN candidate. Actual speed depends on your network and time; use Fastest to probe returned URLs.",
    biliUposAuto: "⚡ Automatic (Prioritize Overseas Alibaba / Tencent CDN)",
    biliUposFastest: "🧪 Fastest (Probe returned backup URLs before download)",
    biliUposAliOv: "🌏 Alibaba Overseas CDN (upos-sz-mirroraliov) — Manual candidate",
  ...
  zh: {
    ...
    biliDownloadEngineLabel: "Bilibili 下载器：",
    biliDownloadEngineTip: "aria2 为 .m4s 文件建立多个 HTTP Range 连接；清单仍使用原生下载器。",
    biliDownloadEngineAuto: "⚡ 自动 (有 aria2 时使用，失败回退原生)",
    biliDownloadEngineNative: "🧩 原生 yt-dlp",
    biliDownloadEngineAria2: "🚀 aria2 多 Range",
    biliAria2ConnectionsLabel: "每个文件的连接数：",
    biliAria2ConnectionsTip: "单个文件的 Range 连接数。建议从 8 开始；过多可能触发 403/429。",
    biliAria2Checking: "正在检查 aria2...",
    biliAria2Ready: "✅ aria2 已就绪",
    biliAria2Unavailable: "ℹ️ 未找到 aria2 — 自动使用原生下载",
    biliAria2ChunkIgnored: "aria2 自动切分 Range；原生 chunk 设置被忽略",
    switchSubtitles: "字幕",
    switchThumbnail: "封面",
    switchMetadata: "元数据",
    switchPlaylist: "播放列表",
    ...
    biliUposHostTip: "选择 UPOS CDN 候选节点。实际速度取决于网络和时间；使用 Fastest 测试 B 站返回的 URL。",
    biliUposAuto: "⚡ 自动优选 (优先阿里 / 腾讯海外 CDN)",
    biliUposFastest: "🧪 Fastest (下载前测试实际 backup URL)",
    biliUposAliOv: "🌏 阿里海外 CDN (upos-sz-mirroraliov) — 手动候选",
  ...
  ja: {
    ...
    biliDownloadEngineLabel: "Bilibili ダウンローダー：",
    biliDownloadEngineTip: "aria2 は .m4s に複数の HTTP Range 接続を使い、マニフェストはネイティブのまま処理します。",
    biliDownloadEngineAuto: "⚡ 自動 (aria2 があれば使用、失敗時はネイティブ)",
    biliDownloadEngineNative: "🧩 ネイティブ yt-dlp",
    biliDownloadEngineAria2: "🚀 aria2 マルチ Range",
    biliAria2ConnectionsLabel: "ファイルごとの接続数：",
    biliAria2ConnectionsTip: "1 ファイルの Range 接続数。まず 8 を推奨。多すぎると 403/429 の可能性があります。",
    biliAria2Checking: "aria2 を確認中...",
    biliAria2Ready: "✅ aria2 準備完了",
    biliAria2Unavailable: "ℹ️ aria2 なし — 自動的にネイティブを使用",
    biliAria2ChunkIgnored: "aria2 が Range を分割するため、ネイティブ chunk は無視されます",
    switchSubtitles: "字幕",
    ...
    biliUposHostTip: "UPOS CDN 候補を選択します。実際の速度はネットワークと時間帯に依存するため、Fastest で返却 URL を測定できます。",
    biliUposAuto: "⚡ 自動選択 (海外 Alibaba / Tencent CDN 優先)",
    biliUposFastest: "🧪 Fastest (実際の backup URL を事前測定)",
    biliUposAliOv: "🌏 Alibaba 海外 CDN (upos-sz-mirroraliov) — 手動候補",
