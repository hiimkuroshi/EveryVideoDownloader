...
const I18N = {
  vi: {
    ...
    threads8: "⭐ 8 Luồng (Rất nhanh)",
    threads16: "🚀 16 Luồng (Siêu tốc)",
    threads4: "⚡ 4 Luồng",
    threads1: "🐢 1 Luồng",
    chunkSizeLabel: "Chunk size:",
    chunk10M: "⭐ 10 MB (Khuyên dùng)",
  ...
  en: {
    ...
    threads8: "⭐ 8 Threads (Very Fast)",
    threads16: "🚀 16 Threads (Ultra Fast)",
    threads4: "⚡ 4 Threads",
    threads1: "🐢 1 Thread",
    chunkSizeLabel: "Chunk size:",
    chunk10M: "⭐ 10 MB (Recommended)",
  ...
  zh: {
    ...
    threads8: "⭐ 8 线程 (极速推荐)",
    threads16: "🚀 16 线程 (最高速度)",
    threads4: "⚡ 4 线程",
    threads1: "🐢 1 线程",
    chunkSizeLabel: "分块大小：",
    chunk10M: "⭐ 10 MB (推荐 - 防限速)",
  ...
  ja: {
    ...
    threads8: "⭐ 8 スレッド (推奨・超高速)",
    threads16: "🚀 16 スレッド (最速)",
    threads4: "⚡ 4 スレッド",
    threads1: "🐢 1 スレッド",
    chunkSizeLabel: "チャンクサイズ：",
    chunk10M: "⭐ 10 MB (推奨・速度制限回避)",
