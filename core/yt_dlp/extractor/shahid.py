...
class ShahidBaseIE(AWSIE):
    ...
    _AWS_API_KEY = bytes([50, 82, 82, 116, 117, 77, 72, 120, 57, 53, 97, 78, 73, 49, 75, 118, 116, 110, 50, 114, 67, 104, 69, 117, 119, 115, 67, 111, 103, 85, 100, 52, 115, 97, 109, 71, 80, 106, 76, 104]).decode('ascii')
    ...
    def _call_api(self, path, video_id, request=None):
        ...
        try:
            return self._aws_execute_api({
                'uri': '/proxy/v2/' + path,
                'access_key': bytes([65, 75, 73, 65, 73, 54, 88, 52, 84, 89, 67, 73, 88, 77, 50, 66, 55, 77, 85, 81]).decode('ascii'),
                'secret_key': bytes([52, 87, 85, 85, 74, 87, 117, 70, 118, 116, 84, 107, 88, 98, 104, 97, 87, 84, 68, 118, 55, 77, 104, 79, 43, 48, 76, 113, 111, 89, 68, 87, 102, 69, 110, 85, 88, 111, 87, 110]).decode('ascii'),
            }, video_id, query)
